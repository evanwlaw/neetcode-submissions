class Solution:
    def wordBreak(self, s: str, wordDict: List[str]) -> bool:
        ...
        dp[i] holds the validity if the ith place is the end of a valid word.

        dp[i] is True if s[i - len(curr word) : i] is in wordDict AND if dp[i - len(curr word)] is True
